...
class  UnbreakableParser : public antlr4::Parser {
public:
  enum {
    T__0 = 1, T__1 = 2, T__2 = 3, T__3 = 4, T__4 = 5, T__5 = 6, T__6 = 7, 
    T__7 = 8, T__8 = 9, T__9 = 10, T__10 = 11, T__11 = 12, T__12 = 13, IF = 14, 
    ELSE = 15, MUL_OP = 16, DIV_OP = 17, ADD_OP = 18, SUB_OP = 19, EQ_OP = 20, 
    NEQ_OP = 21, IDENTIFIER = 22, DIGIT = 23, NEWLINE = 24, WS = 25
  };

  enum {
    RuleProg = 0, RuleVarDeclar = 1, RulePrimitiveType = 2, RuleStat = 3, 
    RuleCompound_stat = 4, RuleAssignment_stat = 5, RuleIf_stat = 6, RuleExpr = 7, 
    RuleVariable = 8, RuleNumber = 9, RuleSign = 10, RuleMul_div_op = 11, 
    RuleAdd_sub_op = 12, RuleRel_op = 13
  };

  UnbreakableParser(antlr4::TokenStream *input);
  ~UnbreakableParser();
  ...
  class ProgContext;
  class VarDeclarContext;
  class PrimitiveTypeContext;
  class StatContext;
  class Compound_statContext;
  ...
  class  VarDeclarContext : public antlr4::ParserRuleContext {
  public:
    VarDeclarContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  public:
    ...
    ExprContext *expr();
    VarDeclarContext *varDeclar();
    Compound_statContext *compound_stat();
  ...
  class  Compound_statContext : public antlr4::ParserRuleContext {
  public:
    Compound_statContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    std::vector<StatContext *> stat();
    StatContext* stat(size_t i);
  ...
  public:
    ...
    std::vector<Compound_statContext *> compound_stat();
    Compound_statContext* compound_stat(size_t i);
    ExprContext *expr();
